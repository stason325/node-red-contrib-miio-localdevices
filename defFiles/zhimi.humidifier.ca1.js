...
module.exports = class extends Device {
  ...
  static model = 'zhimi.humidifier.ca1';
  static name = 'Smartmi Evaporative Humidifier';
  static image = 'https://static.home.mi.com/app/image/get/file/developer_1551944227gt6o909y.png';
  ...
  setFanLevel(v) {
    ...
    if (v === 1) {
        return this.miioCall('set_mode', ['silent']);
    }
    if (v === 2) {
        return this.miioCall('set_mode', ['medium']);
    }
    if (v === 3) {
        return this.miioCall('set_mode', ['high']);
    }
