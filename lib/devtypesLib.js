...
class MIIOdevtypesVocabulary {
    static humid_list() {
        return {
            ...
            3: {name: 'Mijia Pure Evaporation (jsq4, jsq5)', model: "deerma.humidifier.jsq4", protocol: "miot", addDef: true},
            4: {name: 'Smartmi Evaporative Humidifier (ca1)', model: "zhimi.humidifier.ca1", protocol: "miio", addDef: true},
            5: {name: 'Smartmi Evaporative Humidifier (ca4)', model: "zhimi.humidifier.ca4", protocol: "miio", addDef: false},
    ...
    static purif_list() {
        return {
            ...
            3: {name:'Mi Air Purifier 2 (m1)', model: "zhimi.airpurifier.m1", protocol: "miio", addDef: true},
            4: {name:'Mi Air Purifier 2S (ma2)', model: "zhimi.airpurifier.ma2", protocol: "miio", addDef: true},
            5: {name:'Mi Air Purifier 3 (ma4)', model: "zhimi.airpurifier.ma4", protocol: "miot", addDef: false},
            6: {name:'Mi Air Purifier 3H (mb3)', model: "zhimi.airpurifier.mb3", protocol: "miot", addDef: false},
            7: {name:'Mi Air Purifier 3C (mb4)', model: "zhimi.airpurifier.mb4", protocol: "miot", addDef: true},
            8: {name:'Mi Air Purifier 2S (mc1)', model: "zhimi.airpurifier.mc1", protocol: "miio", addDef: true},
            9: {name:'Mi Air Purifier 2H (mc2)', model: "zhimi.airpurifier.mc2", protocol: "miot", addDef:false},
            10: {name:'Mijia New Fan A1 (a1)', model: "dmaker.airfresh.a1", protocol: "miio", addDef:true}
        };
    };
    ...
    static heatfan_list() {
        return {
            ...
            2: {name:'Smartmi Smart Bidet Toilet Seat Pro (sa1)', model: "zhimi.toilet.sa1", protocol: "miot", addDef: true},
            3: {name:'Smartmi Standing Fan 1 (sa1, za1), 2 (za3), 2S (za4)', model: "zhimi.fan.za4", protocol: "miio", addDef: false},
            4: {name:'Mi Smart Standing Fan 2 (p10, p18)', model: "dmaker.fan.p18", protocol: "miot", addDef: true},
            5: {name:'Smartmi Standing Fan 3 (za5)', model: "zhimi.fan.za5", protocol: "miot", addDef: true},
            6: {name:'Mi Smart Standing Fan 2 Lite (1c)', model: "dmaker.fan.1c", protocol: "miot", addDef: true},
        };
    };
